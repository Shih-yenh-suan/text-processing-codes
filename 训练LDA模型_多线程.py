    ...
    with concurrent.futures.ProcessPoolExecutor() as executor:
        ...
        for num_topics in num_topics_range:
            future = executor.submit(
                calculate_perplexity, corpus, test_corpus, dictionary, num_topics, num_iterations)
            futures.append(future)

        for future in concurrent.futures.as_completed(futures):
            perplexities.append(future.result())
...
def calculate_perplexity(corpus, test_corpus, dictionary, num_topics, num_iterations):
    # Train LDA model
    ...
    return (num_topics, calc_perplexity)
